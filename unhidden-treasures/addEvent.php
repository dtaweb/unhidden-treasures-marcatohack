...
<form action="./checkEventAdd.php" method="POST">
	<div id="content">
			...
			<div id="new-event-name"><input id="new-event-name-input" type="text" name="event_name" value="" />
			<font color='black' style='font-size:20pt;'><B>*</B></font>
			</div>		
			<div id="new-event-contact"><input id="new-event-contact-input" type="text" name="contact" value="" />
			<font color='black' style='font-size:20pt;'><B>*</B></font>
			</div>		
			<div id="new-event-startDate"><input id="new-event-startDate-input" type="text" name="start_date" value="" />
			<font color='black' style='font-size:20pt;'><B>*</B></font>
			</div>		
...
<font color='black' style='font-size:20pt;'><B>*</B></font>
			...
			<div id="new-event-location"><input id="new-event-location-input" type="text" name="location" value="" />
			<font color='black' style='font-size:20pt;'><B>*</B></font>
			</div>		
			<div id="new-event-description"><textarea id="new-event-description-input" name="description"></textarea>
			<font color='black' style='font-size:20pt;'><B>*</B></font>
			</div>				
