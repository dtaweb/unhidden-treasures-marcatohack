...
<form action="./checkEventAdd.php" method="POST">
	<div id="content">
			<div id="new-event-info"><img src="images/new-event-info.png"></div>		
			<div id="new-event-name"><input id="new-event-name-input" type="text" name="event_name" value="<?php echo "".stripslashes($event_name).""; ?>" />
			<?php if (empty($event_name)) echo "<font color='black' style='font-size:20pt;'><B>*</B></font>"; ?>
			</div>		
			<div id="new-event-contact"><input id="new-event-contact-input" type="text" name="contact" value="<?php echo "".stripslashes($contact).""; ?>" />
			<?php if (empty($contact)) echo "<font color='black' style='font-size:20pt;'><B>*</B></font>"; ?>
			</div>		
			<div id="new-event-startDate"><input id="new-event-startDate-input" type="text" name="start_date" value="<?php echo "".stripslashes($start_date).""; ?>" />
			<?php if (empty($start_date)) echo "<font color='black' style='font-size:20pt;'><B>*</B></font>"; ?>
			</div>		
			<div id="new-event-category"><select id="new-event-category-input" name="category_id"><option value=""></option>
<?php 
...
?></select>		
			<?php if (empty($category_id)) echo "<font color='black' style='font-size:20pt;'><B>*</B></font>"; ?>
			</div>		
			<div id="new-event-location"><input id="new-event-location-input" type="text" name="location" value="<?php echo "".stripslashes($location).""; ?>" />
			<?php if (empty($location)) echo "<font color='black' style='font-size:20pt;'><B>*</B></font>"; ?>
			</div>		
			<div id="new-event-description"><textarea id="new-event-description-input" name="description"><?php echo "".stripslashes($description).""; ?></textarea>
			<?php if (empty($description)) echo "<font color='black' style='font-size:20pt;'><B>*</B></font>"; ?>
			</div>				
			<div id="new-event-submit-footer">
				<div id="new-event-submit-pad"></div>
				<div id="new-event-submit"><input type="image" src="images/new-event-submit.png"></div>
			</div>	
	</div>
</form>
</div>
